...
@freezed
class SocialAccount with _$SocialAccount, Comparable<SocialAccount> {
  ...
  factory SocialAccount.email(String emailAddress, {Color? iconColor}) =>
  ...
  factory SocialAccount.phone(String number, {Color? iconColor}) =>
      SocialAccount._default(
  ...
  factory SocialAccount.whatsapp(String number, {Color? iconColor}) =>
      SocialAccount._default(
  ...
  factory SocialAccount.telegram(String username, {Color? iconColor}) =>
      SocialAccount._default(
  ...
  factory SocialAccount.facebook(String username, {Color? iconColor}) =>
      SocialAccount._default(
  ...
  factory SocialAccount.discord(String userid, {Color? iconColor}) =>
      SocialAccount._default(
  ...
  factory SocialAccount.instagram(String username, {Color? iconColor}) =>
      SocialAccount._default(
  ...
  factory SocialAccount.tiktok(String username, {Color? iconColor}) =>
      SocialAccount._default(
  ...
  factory SocialAccount.snapchat(String username, {Color? iconColor}) =>
      SocialAccount._default(
  ...
  factory SocialAccount.skype(String username, {Color? iconColor}) =>
      SocialAccount._default(
  ...
  factory SocialAccount.viber(String number, {Color? iconColor}) =>
      SocialAccount._default(
  ...
  factory SocialAccount.twitter(String username, {Color? iconColor}) =>
      SocialAccount._default(
  ...
  factory SocialAccount.linkedin(String userid, {Color? iconColor}) =>
      SocialAccount._default(
  ...
  factory SocialAccount.xing(String username, {Color? iconColor}) =>
      SocialAccount._default(
        icon:
  ...
  factory SocialAccount.tumblr(String username, {Color? iconColor}) =>
      SocialAccount._default(
  ...
  factory SocialAccount.wechat(String username, {Color? iconColor}) =>
      SocialAccount._default(
  ...
  factory SocialAccount.sinaweibo(String userid, {Color? iconColor}) =>
      SocialAccount._default(
  ...
  factory SocialAccount.line(String lineId, {Color? iconColor}) =>
      SocialAccount._default(
        icon:
  ...
  factory SocialAccount.threema(String username, {Color? iconColor}) =>
      SocialAccount._default(
  ...
  factory SocialAccount.element(String username, {Color? iconColor}) =>
      SocialAccount._default(
  ...
  factory SocialAccount.reddit(String username, {Color? iconColor}) =>
      SocialAccount._default(
  ...
  factory SocialAccount.tinder(String username, {Color? iconColor}) =>
      SocialAccount._default(
  ...
  factory SocialAccount.icq(String icqNumber, {Color? iconColor}) =>
      SocialAccount._default(
        icon:
  ...
  factory SocialAccount.imgur(String username, {Color? iconColor}) =>
      SocialAccount._default(
  ...
  factory SocialAccount.kakaotalk(String username, {Color? iconColor}) =>
      SocialAccount._default(
        icon: Icon(SimpleIcons.kakaotalk,
            color: iconColor ?? const Color(0xFF1BB76E)),
        name: 'KaKaoTalk',
        identifier: username,
        prelink: (String username) => '', //TODO(jr): to be found out
...
final socialAccountsAll = <String, SocialAccount Function(String)>{
  ...
  'kakaotalk': (String identifier) => SocialAccount.kakaotalk(identifier),
